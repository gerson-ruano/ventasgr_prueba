...
return [
    ...
    */
    ...
    | permite especificar un mensaje personalizado específico para una regla dada de
    | un atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para intercambiar nuestros
    | marcadores de posición de atributos con algo más amigable para el lector, como
    | "Dirección de Correo Electrónico" en lugar de "email". Esto simplemente nos ayuda
    | a hacer que nuestro mensaje sea más expresivo.
    |
    */
