<x-app-layout>
    ...
    themeToggle.addEventListener('change', () => {
        const theme = themeToggle.checked ? 'dark' :
            'light'; // Cambia 'default' al tema que desees aplicar cuando el checkbox no esté marcado
    ...
    <main class="grid card rounded-box place-items-center">
        <div class="flex flex-col w-full lg:flex-row lg:space-y-0">
            <div class="lg:w-3/4">
                <div class="grid flex-grow card bg-base-300 rounded-box place-items-center mb-1 ml-2 lg:mb-1 lg:ml-0 lg:mr-2">Muestra el carrito de Productos 
            ...
            <div class="lg:w-1/4">
                <div class="grid flex-grow h-32 card bg-base-300 rounded-box place-items-center mb-1 ml-2 lg:mb-2 lg:ml-0 lg:mr-2">contenido de la segunda columna

                </div>
                <div class="grid flex-grow h-32 card bg-base-300 rounded-box place-items-center mb-1 ml-2 lg:mb-2 lg:ml-0 lg:mr-2">Contenido de la tercera columna

                </div>
                <div class="grid flex-grow h-32 card bg-base-300 rounded-box place-items-center mb-1 ml-2 lg:mb-2 lg:ml-0 lg:mr-2">Contenido de la cuarta columna

                </div>
                <div class="grid flex-grow h-32 card bg-base-300 rounded-box place-items-center mb-1 ml-2 lg:mb-2 lg:ml-0 lg:mr-2">Contenido de la quinta columna
