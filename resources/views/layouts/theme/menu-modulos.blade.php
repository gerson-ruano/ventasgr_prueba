...
<ul class="menu lg:menu-horizontal w-full bg-base-200 lg:mb-0">
    <li>
        <details class="">
            <summary
            <a class="border dark:border-gray-200 {{ Auth::user()->hasRole('Admin|Seller|Employee') ? '' : 'opacity-50 pointer-events-none' }}">
                {{--}}href="{{url('pos')}}">--}}
    ...
    <li>
        <details class="">
            <summary
                class="border dark:border-gray-200 flex item-center {{ Auth::user()->hasRole('Admin|Employee') ? '' : 'opacity-50 pointer-events-none' }}">
    ...
    <li class="ml-1">
        <details>
            <summary
                class="border dark:border-gray-200 flex item-center {{ Auth::user()->hasRole('Admin') ? '' : 'opacity-50 pointer-events-none' }}">
    ...
    <li class="ml-auto">
        <label class="flex cursor-pointer gap-2">
            ...
            <input type="checkbox" value="dark" class="toggle theme-controller" id="themeToggle" {{ auth()->user()->tema == 0 ? 'checked' : '' }}/>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                 stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
