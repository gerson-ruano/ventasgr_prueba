<div>
    ...
    <div class="flex justify-center items-center mt-1 mb-1 mr-1 ml-1">
        ...
        <div class="mb-4">
            <label for="role" class="text-center block text-sm font-medium text-gray-700">Role</label>
            <select wire:model="role" class="select select-info w-full">
                ...
                <tr class="bg-white dark:bg-gray-700 border-b dark:border-gray-600">
                    ...
                    <td class="text-center">
                        <div class="form-control">
                            <label class="label cursor-pointer d-flex align-items-center">
